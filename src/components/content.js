const Content = ({ title }) => (
  <div>
    <div
      className="flex flex-wrap md:flex-nowrap items-center justify-between w-full rounded-2xl py-6 px-12"
      style={{
        backgroundColor:
    ...
    >
      <div>
        <h3 className="flex items-center m-0 font-medium text-lg">
          <svg viewBox="0 0 512 512" className="w-12 lg:w-8 mr-3">
            <path
        ...
        <button className="py-2 px-4 bg-blue-700 text-white rounded-2xl">
          Start free trial
        </button>
      </div>
      <img
        className="w-24 md:w-44 object-cover object-center"
        src="https://assets.codepen.io/3364143/glass.png"
        alt=""
      />
    </div>
    <div className="mt-6 mb-3 text-gray-700 font-medium">Installed</div>
    <div
      className="p-4 font-normal rounded-2xl"
      style={{ backgroundColor: 'rgba(158, 158, 158, 0.3)' }}
    >
      <div className="flex justify-end pb-2 mb-6 border-b border-gray-600">
        ...
        <div className="mx-auto flex">
          <span className="relative text-base">
            <span className="h-2 w-2 absolute rounded-full top-1 left--2 bg-green-400" />
            <span className="pl-4">Updated</span>
          </span>
        </div>
        <div className="ml-auto flex">
          <div>
            <button className="border-gray-500 rounded-full px-5 py-1 border text-gray-500">
              Open
            </button>
          </div>
        </div>
      ...
      <div className="flex justify-end pb-2 mb-6 border-b border-gray-600">
        ...
        <div className="mx-auto flex">
          <span className="relative text-base">
            <span className="h-2 w-2 absolute rounded-full top-1 left--2 bg-indigo-400" />
            <span className="pl-4">Updated</span>
          </span>
        </div>
        <div className="ml-auto flex">
                  ...
                  <tr>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="whitespace-no-wrap">Jean marc</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <p className="whitespace-no-wrap">12/09/2020</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                  ...
                  <tr>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="whitespace-no-wrap">Marcus coco</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <p className="whitespace-no-wrap">01/10/2012</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                  ...
                  <tr>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="whitespace-no-wrap">Eric marc</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <p className="whitespace-no-wrap">Developer</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <p className="whitespace-no-wrap">02/10/2018</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <span className="relative inline-block px-3 py-1 font-semibold leading-tight">
                        <span
                  ...
                  <tr>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          <p className="whitespace-no-wrap">Julien Huger</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <p className="whitespace-no-wrap">23/09/2010</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 text-sm">
                      <span className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                        <span
