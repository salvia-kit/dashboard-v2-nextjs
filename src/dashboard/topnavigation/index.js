      ...
      <div className="flex flex-center flex-col h-full justify-center mx-auto px-3 relative">
        <div className="flex items-center pl-1 relative w-full sm:pr-2 sm:ml-0 lg:max-w-68 ">
          <div className="container flex h-auto h-full left-0 relative w-3/4">
            ...
            <div className="group h-full hidden items-center relative w-full md:flex lg:w-64">
              ...
              <input
                ...
                placeholder="Search"
              />
              <div className="absolute border border-gray-300 h-auto hidden mr-2 px-2 py-1 right-0 rounded-2xl text-xs text-gray-400 md:block">
                +
              </div>
            </div>
          </div>
          <div className="flex items-center justify-end ml-5 p-1 relative w-9/12 sm:mr-0 sm:right-auto md:w-1/4">
            <a className="block pr-1 text-gray-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                viewBox="0 0 20 20"
            ...
            <a
              href="#"
              className="block inline-block py-2 px-3 relative rounded text-gray-700"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="absolute bg-blue-700 font-bold px-2 py-0.5 right-0 rounded-full text-white text-xs top-0">
                3
              </span>
            </a>
